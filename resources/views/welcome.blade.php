    ...
    <body>
        ...
        <div class="middle" id="middle">
            ...
            <span class="links">
                ...
                <br><br>
                I would suggest using a browser which uses webkit, such as Chrome or Opera. However, all browsers should work fine (except Internet explorer, however if you choose to use internet explorer, you don't deserve to use Cordial!)
            </span>
            <br>
